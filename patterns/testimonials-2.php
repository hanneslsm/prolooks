...
<figure class="wp-block-image aligncenter size-full is-resized is-style-default"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder.png" alt="" class="" style="aspect-ratio:1;object-fit:cover;width:128px"/></figure>
<!-- /wp:image -->
...
echo sprintf( esc_html__( '%1$s“Sit itaque minima aut architecto nesciunt aut vero nobis? Nam autem corporis est ullam natus et doloremque consequatur ut consequatur delectus.%2$s', 'prolooks' ), '<em>', '</em>' ); ?></p>
<!-- /wp:paragraph -->
