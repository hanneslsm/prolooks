 ...
 */
?>
<!-- wp:group {"style":{"border":{"top":{"color":"var:preset|color|base-4","width":"1px"}},"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|contrast-5"}}}},"backgroundColor":"base-2","textColor":"contrast-5","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-5-color has-base-2-background-color has-text-color has-background has-link-color" style="border-top-color:var(--wp--preset--color--base-4);border-top-width:1px;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:columns {"align":"wide"} -->
...
<!-- wp:social-links {"iconColor":"contrast-5","iconColorValue":"#667085","className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"center"}} -->
<ul class="wp-block-social-links has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"https://wordpress.org","service":"wordpress","rel":"https://wordpress.org"} /--></ul>
<!-- /wp:social-links -->
